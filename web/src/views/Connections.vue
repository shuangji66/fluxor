    ...
    <div class="glass-medium shadow-none px-6 py-3 md:py-0 rounded-lg border border-apple-border flex flex-wrap gap-4 items-center justify-between transition-all shrink-0 h-auto min-h-[56px] md:h-[56px]">
      <div class="flex flex-wrap items-center gap-x-4 gap-y-2 flex-1 md:flex-initial">
        ...
        <div class="flex bg-apple-input rounded-full p-0.5 transition-all border border-apple-border relative select-none w-full sm:w-64">
          ...
          ></div>
          <button @click="activeTab = 'active'" class="flex-1 px-4 py-1.5 text-xs font-semibold rounded-full transition-all duration-200 active:scale-95 z-10 text-center" :class="activeTab === 'active' ? 'text-white' : 'text-apple-text-muted hover:text-apple-text'">
            {{ t('connections.active') }} ({{ activeConnections.length }})
          </button>
          <button @click="activeTab = 'closed'" class="flex-1 px-4 py-1.5 text-xs font-semibold rounded-full transition-all duration-200 active:scale-95 z-10 text-center" :class="activeTab === 'closed' ? 'text-white' : 'text-apple-text-muted hover:text-apple-text'">
