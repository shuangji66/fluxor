...
const messages = {
  zh: {
    ...
    'overview.local_ip': '本机 IP',
    'overview.proxy_ip': '代理 IP',
    'overview.proxy_port': '代理端口',
    'overview.no_ipinfo': '未获取到ip',
    'overview.proxy_delay_test': '代理延迟测试',
    ...
    'about.description': '轻量级、零臃肿的 Mihomo 内核管理面板',
    'about.version': '面板版本',
  ...
  en: {
    ...
    'overview.local_ip': 'Local IP',
    'overview.proxy_ip': 'Proxy IP',
    'overview.proxy_port': 'Proxy Port',
    'overview.no_ipinfo': 'No IP available',
    'overview.proxy_delay_test': 'Proxy Delay Test',
    ...
    'config.tun_settings': 'Interface & TUN Settings',
    'config.theme': 'Theme',
    ...
    'about.description': 'Lightweight, Zero-bloat Mihomo Kernel Management Panel',
